...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	// CommonJS
		...
		exports["wingifySdk"] = factory();
	// Root
	else
		root["wingifySdk"] = factory();
})(this, () => {
 ...
 * limitations under the License.
 */
var WingifyBuilder_1 = __webpack_require__(/*! ./WingifyBuilder */ "./lib/WingifyBuilder.ts");
...
var WingifyClient_1 = __webpack_require__(/*! ./WingifyClient */ "./lib/WingifyClient.ts");
...
var WingifyBuilder = /** @class */ (function () {
    ...
    WingifyBuilder.prototype.setStorage = function () {
        ...
        if (this.options.storage) {
            ...
            this.logManager.debug((0, LogMessageUtil_1.buildMessage)(log_messages_1.DebugLogMessagesEnum.SERVICE_INITIALIZED, {
                service: ((_e = (_d = this.options) === null || _d === void 0 ? void 0 : _d.clientStorage) === null || _e === void 0 ? void 0 : _e.provider) === sessionStorage
                    ? constants_1.Constants.SESSION_STORAGE_NAME
                    : constants_1.Constants.LOCAL_STORAGE_NAME,
            }));
            this.settingFileManager.isStorageServiceProvided = true;
        }
        else {
 ...
 * limitations under the License.
 */
var wingify_fme_sdk_log_messages_1 = __importDefault(__webpack_require__(/*! wingify-fme-sdk-log-messages */ "./node_modules/wingify-fme-sdk-log-messages/index.js"));
...
/***/ "./lib/models/user/ContextWingifyModel.ts":
/*!************************************************!*\
  !*** ./lib/models/user/ContextWingifyModel.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var ContextWingifyModel_1 = __webpack_require__(/*! ../../../models/user/ContextWingifyModel */ "./lib/models/user/ContextWingifyModel.ts");
var DataTypeUtil_1 = __webpack_require__(/*! ../../../utils/DataTypeUtil */ "./lib/utils/DataTypeUtil.ts");
var ApiEnum_1 = __webpack_require__(/*! ../../../enums/ApiEnum */ "./lib/enums/ApiEnum.ts");
var FunctionUtil_1 = __webpack_require__(/*! ../../../utils/FunctionUtil */ "./lib/utils/FunctionUtil.ts");
 ...
 */
var _isRolloutRuleForFeaturePassed = function (serviceContainer, feature, evaluatedFeatureMap, featureToSkip, storageService, context) { return __awaiter(void 0, void 0, void 0, function () {
 ...
 */
var _getEligbleCampaigns = function (serviceContainer, campaignMap, context, storageService) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                _loop_2 = function (campaign) {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [4 /*yield*/, new StorageDecorator_1.StorageDecorator().getFeatureFromStorage(featureKey, context, storageService, serviceContainer)];
                            case 1:
                                storedData = _d.sent();
 ...
 */
var _findWinnerCampaignAmongEligibleCampaigns = function (serviceContainer, featureKey, eligibleCampaigns, eligibleCampaignsWithStorage, groupId, context, storageService) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        ...
        megAlgoNumber = !(0, DataTypeUtil_1.isUndefined)((_b = (_a = serviceContainer.getSettings()) === null || _a === void 0 ? void 0 : _a.getGroups()[groupId]) === null || _b === void 0 ? void 0 : _b.et)
...
var _getCampaignUsingAdvancedAlgo = function (serviceContainer, shortlistedCampaigns, context, calledCampaignIds, groupId, storageService) {
    ...
    var priorityOrder = !(0, DataTypeUtil_1.isUndefined)(serviceContainer.getSettings().getGroups()[groupId].p)
        ? serviceContainer.getSettings().getGroups()[groupId].p
        : {};
    var wt = !(0, DataTypeUtil_1.isUndefined)(serviceContainer.getSettings().getGroups()[groupId].wt)
...
/***/ "./node_modules/wingify-fme-sdk-log-messages/index.js":
/*!************************************************************!*\
  !*** ./node_modules/wingify-fme-sdk-log-messages/index.js ***!
  \************************************************************/
...
module.exports = {
  debugMessages: __webpack_require__(/*! ./src/debug-messages.json */ "./node_modules/wingify-fme-sdk-log-messages/src/debug-messages.json"),
  infoMessages: __webpack_require__(/*! ./src/info-messages.json */ "./node_modules/wingify-fme-sdk-log-messages/src/info-messages.json"),
  warnMessages: __webpack_require__(/*! ./src/warn-messages.json */ "./node_modules/wingify-fme-sdk-log-messages/src/warn-messages.json"),
  errorMessages: __webpack_require__(/*! ./src/error-messages.json */ "./node_modules/wingify-fme-sdk-log-messages/src/error-messages.json"),
  errorMessagesV2: __webpack_require__(/*! ./src/error-messages-v2.json */ "./node_modules/wingify-fme-sdk-log-messages/src/error-messages-v2.json"),
  traceMessages: __webpack_require__(/*! ./src/trace-messages.json */ "./node_modules/wingify-fme-sdk-log-messages/src/trace-messages.json")
}


/***/ }),

/***/ "./node_modules/wingify-fme-sdk-log-messages/src/debug-messages.json":
/*!***************************************************************************!*\
  !*** ./node_modules/wingify-fme-sdk-log-messages/src/debug-messages.json ***!
  \***************************************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/wingify-fme-sdk-log-messages/src/error-messages-v2.json":
/*!******************************************************************************!*\
  !*** ./node_modules/wingify-fme-sdk-log-messages/src/error-messages-v2.json ***!
  \******************************************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"INIT_OPTIONS_ERROR":"[ERROR]: {logPrefix} {date} Options should be of type object","INIT_OPTIONS_SDK_KEY_ERROR":"[ERROR]: {logPrefix} {date} Please provide the sdkKey in the options and should be a of type string","INIT_OPTIONS_ACCOUNT_ID_ERROR":"[ERROR]: {logPrefix} {date} Please provide {brand} account ID in the options and should be a of type string|number","INIT_OPTIONS_INVALID":"Invalid key:{key} passed in options. Should be of type:{correctType} and greater than equal to 1000","SETTINGS_FETCH_ERROR":"Settings could not be fetched. Error:{err}","SETTINGS_SCHEMA_INVALID":"Settings are not valid. Failed schema validation","POLLING_FETCH_SETTINGS_FAILED":"Error while fetching {brand} settings with polling","API_THROW_ERROR":"API - {apiName} failed to execute. Trace:{err}","API_INVALID_PARAM":"Key:{key} passed to API:{apiName} is not of valid type. Got type:{type}, should be:{correctType}","API_SETTING_INVALID":"Settings are not valid. Contact {brand} Support","API_CONTEXT_INVALID":"Context should be an object and must contain a mandatory key - id, which is User ID","FEATURE_NOT_FOUND":"Feature not found for the key:{featureKey}","EVENT_NOT_FOUND":"Event:{eventName} not found in any of the features\' metrics","STORED_DATA_ERROR":"Error in getting data from storage. Error:{err}","STORING_DATA_ERROR":"Key:{featureKey} is not valid. Not able to store data into storage","GATEWAY_URL_ERROR":"Please provide a valid URL for {brand} Gateway Service while initializing the SDK","NETWORK_CALL_FAILED":"Error occurred while sending {method} request. Error:{err}","SETTINGS_FETCH_FAILED":"Failed to fetch settings and hence {brand} client instance couldn\'t be updated when API: {apiName} got called having isViaWebhook param as {isViaWebhook}. Error: {err}","NETWORK_CALL_RETRY_ATTEMPT":"Request failed for {endPoint}, Error: {err}. Retrying in {delay} seconds, attempt {attempt} of {maxRetries}","NETWORK_CALL_RETRY_FAILED":"Max retries reached. Request failed for {endPoint}, Error: {err}","CONFIG_PARAMETER_INVALID":"{parameter} paased in {api} API is not correct. It should be of type:{type}}","BATCH_QUEUE_EMPTY":"No batch queue present for account:{accountId} when calling flushEvents API. Check batchEvents config in launch API","RETRY_CONFIG_INVALID":"Retry config is invalid. Please check the {brand} developer documentation. Current retry config: {retryConfig}","SDK_INIT_EVENT_FAILED":"Error occurred while sending SDK init event. Error:{err}","INVALID_NETWORK_RESPONSE_DATA":"Received invalid or empty response data from the network request","ALIAS_NOT_ENABLED":"Aliasing is not enabled. Set isAliasingEnabled in init to enable aliasing"}');

/***/ }),

/***/ "./node_modules/wingify-fme-sdk-log-messages/src/info-messages.json":
/*!**************************************************************************!*\
  !*** ./node_modules/wingify-fme-sdk-log-messages/src/info-messages.json ***!
  \**************************************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/wingify-fme-sdk-log-messages/src/trace-messages.json":
/*!***************************************************************************!*\
  !*** ./node_modules/wingify-fme-sdk-log-messages/src/trace-messages.json ***!
  \***************************************************************************/
/***/ ((module) => {
...
/***/ "./node_modules/wingify-fme-sdk-log-messages/src/warn-messages.json":
/*!**************************************************************************!*\
  !*** ./node_modules/wingify-fme-sdk-log-messages/src/warn-messages.json ***!
  \**************************************************************************/
/***/ ((module) => {
...
var Wingify_1 = __webpack_require__(/*! ./Wingify */ "./lib/Wingify.ts");
Object.defineProperty(exports, "init", ({ enumerable: true, get: function () { return Wingify_1.init; } }));
Object.defineProperty(exports, "onInit", ({ enumerable: true, get: function () { return Wingify_1.onInit; } }));
...
//# sourceMappingURL=wingify-fme-javascript-sdk.js.map