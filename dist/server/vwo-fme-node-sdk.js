  ...
  StorageDecorator.prototype.setDataInStorage = function (data, storageService, serviceContainer) {
    ...
    if (!featureKey) {
      serviceContainer.getLogManager().errorLog('ERROR_STORING_DATA_IN_STORAGE', {
        ...
        an: ApiEnum_1.ApiEnum.GET_FLAG,
        uuid: context._vwo_uuid,
        sId: context._vwo_sessionId
      });
...
var ContextModel = /** @class */function () {
  ...
  ContextModel.prototype.modelFromDictionary = function (context, options) {
    ...
    this._vwo_uuid = (_a = context === null || context === void 0 ? void 0 : context.uuid) !== null && _a !== void 0 ? _a : (0, UuidUtil_1.getUUID)((_c = (_b = context === null || context === void 0 ? void 0 : context.id) === null || _b === void 0 ? void 0 : _b.toString()) !== null && _c !== void 0 ? _c : "".concat(options === null || options === void 0 ? void 0 : options.accountId, "_").concat(options === null || options === void 0 ? void 0 : options.sdkKey), (_d = options === null || options === void 0 ? void 0 : options.accountId) === null || _d === void 0 ? void 0 : _d.toString());
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 4:
          ...
          payload = (0, NetworkUtil_1.createHoldoutPayload)(serviceContainer, EventEnum_1.EventEnum.VWO_VARIATION_SHOWN, holdout.getId(),
      ...
      switch (_b.label) {
        case 0:
          ...
          if (properties.en === EventEnum_1.EventEnum.VWO_VARIATION_SHOWN) {
            ...
            } else if (properties.en !== EventEnum_1.EventEnum.VWO_DEBUGGER_EVENT && properties.en !== EventEnum_1.EventEnum.VWO_LOG_EVENT && properties.en !== EventEnum_1.EventEnum.VWO_INIT_CALLED) {
              apiName = ApiEnum_1.ApiEnum.TRACK_EVENT;
