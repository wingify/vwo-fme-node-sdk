 ...
 *  3. uuid - ^9.0.1
 *  4. wingify-fme-sdk-log-messages - ^2.0.0
 */
/******/ (() => { // webpackBootstrap
...
/***/ "./dist/server-unpacked/Wingify.js":
/*!*****************************************!*\
  !*** ./dist/server-unpacked/Wingify.js ***!
  \*****************************************/
 ...
 * limitations under the License.
 */
var WingifyBuilder_1 = __webpack_require__(/*! ./WingifyBuilder */ "./dist/server-unpacked/WingifyBuilder.js");
...
var Wingify = /** @class */function () {
   ...
   */
  Wingify.setInstance = function (options) {
    var _this = this;
    var startTimeForInit = Date.now();
    var optionsWingifyBuilder = (options === null || options === void 0 ? void 0 : options.wingifyBuilder) || (options === null || options === void 0 ? void 0 : options.vwoBuilder);
    this.wingifyBuilder = optionsWingifyBuilder || new WingifyBuilder_1.WingifyBuilder(options);
    this.instance = this.wingifyBuilder.setLogger() // Sets up logging for debugging and monitoring.
    ...
    return this.wingifyBuilder.getSettings().then(function (settings) {
      return _this.wingifyBuilder.build(settings); // Builds the Wingify instance with the fetched settings.
    });
  };
  Object.defineProperty(Wingify, "Instance", {
    /**
...
function init(options) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      try {
        invalidErrorPrefix = "[ERROR]: ".concat(constants_1.Constants.LOG_PREFIX, " ").concat(date, " ");
        ...
        if (options.isAliasingEnabled && !options.gatewayService) {
          msg = invalidErrorPrefix + (0, LogMessageUtil_1.buildMessage)(log_messages_1.ErrorLogMessagesEnum.INVALID_GATEWAY_URL, {
            date: date
          });
        ...
        instance = new Wingify(options);
        _global = {
          vwoInitDeferred: new PromiseUtil_1.Deferred(),
          isSettingsFetched: false,
          instance: null
        };
        return [2 /*return*/, instance.then(function (_wingifyInstance) {
        ...
        console.info("[INFO]: ".concat(constants_1.Constants.LOG_PREFIX, " ").concat(new Date().toISOString(), " ").concat(msg));
      }
      return [2 /*return*/];
    });
  });
      ...
      try {
        ...
        if (_global.isSettingsFetched) {
          ...
          setTimeout(function () {
            ...
            console.error(msg);
            _global.vwoInitDeferred.reject(new Error(constants_1.Constants.SETTINGS_FETCH_ERROR));
          }, 5000);
        }
...
/***/ "./dist/server-unpacked/WingifyBuilder.js":
/*!************************************************!*\
  !*** ./dist/server-unpacked/WingifyBuilder.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var WingifyClient_1 = __webpack_require__(/*! ./WingifyClient */ "./dist/server-unpacked/WingifyClient.js");
...
var NetworkTransportModeEnum_1 = __webpack_require__(/*! ./enums/NetworkTransportModeEnum */ "./dist/server-unpacked/enums/NetworkTransportModeEnum.js");
var WingifyBuilder = /** @class */function () {
  function WingifyBuilder(options) {
   ...
   */
  WingifyBuilder.prototype.setNetworkManager = function () {
    ...
    if (typeof window !== 'undefined' && ((_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.browserConfig) === null || _c === void 0 ? void 0 : _c.networkTransportMode)) {
      ...
      if (!(0, DataTypeUtil_1.isString)(mode) || mode.toLowerCase() !== NetworkTransportModeEnum_1.NetworkTransportModeEnum.XHR.toLowerCase() && mode.toLowerCase() !== NetworkTransportModeEnum_1.NetworkTransportModeEnum.SEND_BEACON.toLowerCase()) {
    ...
    this.logManager.debug((0, LogMessageUtil_1.buildMessage)(log_messages_1.DebugLogMessagesEnum.SERVICE_INITIALIZED, {
      service: constants_1.Constants.NETWORK_LAYER_NAME
    }));
    this.defaultServiceContainer.setNetworkManager(this.networkManager);
    return this;
  };
  WingifyBuilder.prototype.initBatching = function () {
    var _a, _b;
    ...
    if (((_b = this.options) === null || _b === void 0 ? void 0 : _b.isBatchingDisabled) !== true) {
      this.options.batchEventData = __assign({
        eventsPerRequest: constants_1.Constants.DEFAULT_EVENTS_PER_REQUEST,
        requestTimeInterval: constants_1.Constants.DEFAULT_REQUEST_TIME_INTERVAL
      }, this.options.batchEventData || {});
    }
   ...
   */
  WingifyBuilder.prototype.fetchSettings = function () {
    var _this = this;
   ...
   */
  WingifyBuilder.prototype.getSettings = function () {
    var deferredObject = new PromiseUtil_1.Deferred();
    try {
   ...
   * @returns {this} The instance of this builder.
   */
  WingifyBuilder.prototype.setStorage = function () {
    var _a, _b, _c, _d, _e;
    if (this.options.storage) {
      ...
      this.storage = new storage_1.Storage(new BrowserStorageConnector(__assign(__assign({}, browserStorageConfig), {
        alwaysUseCachedSettings: browserStorageConfig === null || browserStorageConfig === void 0 ? void 0 : browserStorageConfig.alwaysUseCachedSettings,
        ttl: browserStorageConfig === null || browserStorageConfig === void 0 ? void 0 : browserStorageConfig.ttl
      }), defaultStorageKey, this.logManager));
      this.logManager.debug((0, LogMessageUtil_1.buildMessage)(log_messages_1.DebugLogMessagesEnum.SERVICE_INITIALIZED, {
        service: ((_e = (_d = this.options) === null || _d === void 0 ? void 0 : _d.clientStorage) === null || _e === void 0 ? void 0 : _e.provider) === sessionStorage ? constants_1.Constants.SESSION_STORAGE_NAME : constants_1.Constants.LOCAL_STORAGE_NAME
      }));
      this.settingFileManager.isStorageServiceProvided = true;
    } else {
   ...
   * @returns {this} The instance of this builder.
   */
  WingifyBuilder.prototype.setSettingsService = function () {
   ...
   */
  WingifyBuilder.prototype.getLogger = function () {
   ...
   */
  WingifyBuilder.prototype.getSettingsService = function () {
   ...
   */
  WingifyBuilder.prototype.getStorage = function () {
    return this.storage;
  };
  /**
   ...
   * @returns {this} The instance of this builder.
   */
  WingifyBuilder.prototype.setLogger = function () {
    this.logManager = new logger_1.LogManager(this.options.logger || {});
    this.logManager.debug((0, LogMessageUtil_1.buildMessage)(log_messages_1.DebugLogMessagesEnum.SERVICE_INITIALIZED, {
      service: constants_1.Constants.LOGGER_NAME
    }));
   ...
   */
  WingifyBuilder.prototype.getRandomUserId = function () {
   ...
   * @returns {this} The instance of this builder.
   */
  WingifyBuilder.prototype.initPolling = function () {
   ...
   */
  WingifyBuilder.prototype.build = function (settings) {
    this.originalSettings = settings;
    this.wingifyInstance = new WingifyClient_1.WingifyClient(settings, this.options, this.defaultServiceContainer);
   ...
   */
  WingifyBuilder.prototype.checkAndPoll = function () {
    var _this = this;
    var _a;
    this.defaultServiceContainer.setPollingStopCallback(function () {
          ...
          switch (_b.label) {
            ...
            case 1:
              ...
              if (latestSettings && Object.keys(latestSettings).length > 0 && JSON.stringify(latestSettings) !== JSON.stringify(this.originalSettings)) {
                ...
                this.logManager.info((0, LogMessageUtil_1.buildMessage)(log_messages_1.InfoLogMessagesEnum.POLLING_SET_SETTINGS));
                ...
                this.logManager.info((0, LogMessageUtil_1.buildMessage)(log_messages_1.InfoLogMessagesEnum.POLLING_NO_CHANGE_IN_SETTINGS));
              }
              return [3 /*break*/, 4];
            case 2:
              ex_1 = _b.sent();
   ...
   */
  WingifyBuilder.prototype.stopPolling = function () {
  ...
  WingifyBuilder.prototype.updatePollIntervalAndCheckAndPoll = function (settings, shouldCheckAndPoll) {
    var _a;
...
exports.WingifyBuilder = WingifyBuilder;

/***/ }),

/***/ "./dist/server-unpacked/WingifyClient.js":
/*!***********************************************!*\
  !*** ./dist/server-unpacked/WingifyClient.js ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var UuidUtil_1 = __webpack_require__(/*! ./utils/UuidUtil */ "./dist/server-unpacked/utils/UuidUtil.js");
var SDKMetaUtil_1 = __webpack_require__(/*! ./utils/SDKMetaUtil */ "./dist/server-unpacked/utils/SDKMetaUtil.js");
        ...
        switch (_c.label) {
          ...
          case 2:
            ...
            if ('bucketingSeed' in contextCopy) {
              ...
              if (seed === undefined || seed === null || (0, DataTypeUtil_1.isNumber)(seed) || (0, DataTypeUtil_1.isObject)(seed) || (0, DataTypeUtil_2.isArray)(seed) || (0, DataTypeUtil_1.isString)(seed) && seed.trim().length === 0) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 4,, 5]);
            this.serviceContainer.getLogManager().debug((0, LogMessageUtil_1.buildMessage)(log_messages_1.DebugLogMessagesEnum.API_CALLED, {
              apiName: ApiEnum_1.ApiEnum.SHUTDOWN
            }));
          ...
          case 4:
            ...
            this.serviceContainer.getLogManager().errorLog('EXECUTION_FAILED', {
              apiName: ApiEnum_1.ApiEnum.SHUTDOWN,
              err: (0, FunctionUtil_1.getFormattedErrorMessage)(err_7)
            }, {
              an: ApiEnum_1.ApiEnum.SHUTDOWN
            });
            return [3 /*break*/, 5];
          case 5:
            return [2 /*return*/];
...
var constants_1 = __webpack_require__(/*! ../constants */ "./dist/server-unpacked/constants/index.js");
var HoldoutUtil_1 = __webpack_require__(/*! ../utils/HoldoutUtil */ "./dist/server-unpacked/utils/HoldoutUtil.js");
      ...
      return __generator(this, function (_2) {
        switch (_2.label) {
          ...
          case 3:
            ...
            updatedHoldoutIds = __spreadArray(__spreadArray([], storedIsInHoldoutId, true), matchedHoldouts.map(function (holdout) {
              return holdout.getId();
            }), true);
            updatedNotInHoldoutIds = __spreadArray(__spreadArray([], storedNotInHoldoutId, true), notMatchedHoldouts.map(function (holdout) {
              return holdout.getId();
            }), true);
          ...
          case 17:
            ...
            if (matchedHoldouts !== null && matchedHoldouts.length > 0 || notMatchedHoldouts !== null && notMatchedHoldouts.length > 0) {
              decision.isHoldoutPresent = true;
            }
            if (!(matchedHoldouts !== null && matchedHoldouts.length > 0)) return [3 /*break*/, 23];
            qualifiedHoldoutNames = matchedHoldouts.map(function (holdout) {
              return holdout.getName();
            }).join(',');
            decision.holdoutIDs = matchedHoldouts.map(function (holdout) {
              return holdout.getId();
            });
            ...
            new StorageDecorator_1.StorageDecorator().setDataInStorage({
              featureKey: featureKey,
              context: context,
              isInHoldoutId: matchedHoldouts.map(function (holdout) {
                return holdout.getId();
              }),
              notInHoldoutId: notMatchedHoldouts.map(function (holdout) {
                return holdout.getId();
              })
            }, storageService, serviceContainer);
          ...
          case 23:
            ...
            notInHoldoutIds.push.apply(notInHoldoutIds, notMatchedHoldouts.map(function (holdout) {
              return holdout.getId();
            }));
            if (!isDevModeForUser) {
          ...
          case 40:
            if (rollOutRules.length === 0) {
              serviceContainer.getLogManager().debug((0, LogMessageUtil_1.buildMessage)(log_messages_1.DebugLogMessagesEnum.EXPERIMENTS_EVALUATION_WHEN_NO_ROLLOUT_PRESENT));
              shouldCheckForExperimentsRules = true;
            }
            _2.label = 41;
          case 41:
          ...
          case 57:
            ...
            if (isEnabled) {
              // set storage data
              new StorageDecorator_1.StorageDecorator().setDataInStorage(__assign(__assign({
                featureKey: featureKey,
...
function sendTrackingUsage(serviceContainer_1, context_1, isTrackingUsageEnabled_1, isDevModeForUser_1, featureKey_1) {
  return __awaiter(this, arguments, void 0, function (serviceContainer, context, isTrackingUsageEnabled, isDevModeForUser, featureKey, shouldAwait) {
    ...
    if (shouldAwait === void 0) {
      shouldAwait = false;
    }
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!isTrackingUsageEnabled || isDevModeForUser) return [2 /*return*/];
  ...
  TrackApi.prototype.track = function (serviceContainer, eventName, context, eventProperties) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            if (!((0, FunctionUtil_1.doesEventBelongToAnyFeature)(eventName, serviceContainer.getSettings()) || (0, FunctionUtil_1.doesEventBelongToAnyHoldout)(eventName, serviceContainer.getSettings()))) return [3 /*break*/, 4];
            if (!serviceContainer.getShouldWaitForTrackingCalls()) return [3 /*break*/, 2];
...
var _brand =  true ? "wingify" : 0;
var _isWingify = _brand === 'wingify';
var packageFile;
var platform;
...
var StorageDecorator = /** @class */function () {
  ...
  StorageDecorator.prototype.setDataInStorage = function (data, storageService, serviceContainer) {
    ...
    var featureKey = data.featureKey,
      ...
      isInHoldoutId = data.isInHoldoutId,
      notInHoldoutId = data.notInHoldoutId;
    if (!featureKey) {
...
/***/ "./dist/server-unpacked/enums/DebuggerCategoryEnum.js":
/*!************************************************************!*\
  !*** ./dist/server-unpacked/enums/DebuggerCategoryEnum.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./dist/server-unpacked/enums/NetworkTransportModeEnum.js":
/*!****************************************************************!*\
  !*** ./dist/server-unpacked/enums/NetworkTransportModeEnum.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
 ...
 * limitations under the License.
 */
var wingify_fme_sdk_log_messages_1 = __importDefault(__webpack_require__(/*! wingify-fme-sdk-log-messages */ "wingify-fme-sdk-log-messages"));
...
/***/ "./dist/server-unpacked/models/campaign/HoldoutModel.js":
/*!**************************************************************!*\
  !*** ./dist/server-unpacked/models/campaign/HoldoutModel.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./dist/server-unpacked/models/edge/EdgeConfigModel.js":
/*!*************************************************************!*\
  !*** ./dist/server-unpacked/models/edge/EdgeConfigModel.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var SettingsSchema = /** @class */function () {
  ...
  SettingsSchema.prototype.initializeSchemas = function () {
    ...
    var holdoutsSchema = (0, superstruct_1.union)([(0, superstruct_1.array)(this.holdoutSchema), (0, superstruct_1.refine)((0, superstruct_1.object)(), 'EmptyObject', function (v) {
...
var HoldoutModel_1 = __webpack_require__(/*! ../campaign/HoldoutModel */ "./dist/server-unpacked/models/campaign/HoldoutModel.js");
...
var ContextWingifyModel_1 = __webpack_require__(/*! ./ContextWingifyModel */ "./dist/server-unpacked/models/user/ContextWingifyModel.js");
var UuidUtil_1 = __webpack_require__(/*! ../../utils/UuidUtil */ "./dist/server-unpacked/utils/UuidUtil.js");
var FunctionUtil_1 = __webpack_require__(/*! ../../utils/FunctionUtil */ "./dist/server-unpacked/utils/FunctionUtil.js");
var ContextModel = /** @class */function () {
  ...
  ContextModel.prototype.modelFromDictionary = function (context, options) {
    ...
    this._wingify_uuid = (_a = context === null || context === void 0 ? void 0 : context.uuid) !== null && _a !== void 0 ? _a : (0, UuidUtil_1.getUUID)((_c = (_b = context === null || context === void 0 ? void 0 : context.id) === null || _b === void 0 ? void 0 : _b.toString()) !== null && _c !== void 0 ? _c : "".concat(options === null || options === void 0 ? void 0 : options.accountId, "_").concat(options === null || options === void 0 ? void 0 : options.sdkKey), (_d = options === null || options === void 0 ? void 0 : options.accountId) === null || _d === void 0 ? void 0 : _d.toString());
...
/***/ "./dist/server-unpacked/models/user/ContextWingifyModel.js":
/*!*****************************************************************!*\
  !*** ./dist/server-unpacked/models/user/ContextWingifyModel.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var LogManager = /** @class */function (_super) {
  ...
  LogManager.prototype.errorLog = function (template, data, debugData, shouldSendToWingify) {
    ...
    if (shouldSendToWingify === void 0) {
      shouldSendToWingify = true;
    }
    try {
...
var NetworkBrowserClient = /** @class */function () {
  function NetworkBrowserClient(logManager, networkTransportMode) {
    if (networkTransportMode === void 0) {
      networkTransportMode = NetworkTransportModeEnum_1.NetworkTransportModeEnum.SEND_BEACON;
    }
  ...
  NetworkBrowserClient.prototype.POST = function (requestModel) {
    ...
    if (this.networkTransportMode.toLowerCase() !== NetworkTransportModeEnum_1.NetworkTransportModeEnum.XHR.toLowerCase() && typeof navigator !== 'undefined' &&
    // not using DataTypeUtil.isUndefined because we want to check for the existence of navigator object in non-browser environments
...
var NetworkClient = /** @class */function () {
  function NetworkClient(logManager, httpsAgentConfig) {
    this.logManager = logManager;
  ...
  NetworkClient.prototype.GET = function (requestModel) {
    ...
    var attemptRequest = function (attempt) {
      ...
      try {
        ...
        if (networkOptions.scheme === Url_1.HTTPS) {
          networkOptions.agent = _this.httpsAgent;
        } else {
          networkOptions.agent = _this.httpAgent;
        }
        ...
        var req = httpClient.get(networkOptions, function (res) {
          ...
          if (error) {
            ...
            res.resume();
            return _this.retryOrReject(error, attempt, deferred, networkOptions, attemptRequest, requestModel, responseModel);
          }
          ...
          res.on('end', function () {
            try {
              ...
              if (responseModel.getStatusCode() < 200 || responseModel.getStatusCode() >= 300) {
                ...
                return _this.retryOrReject(error_1, attempt, deferred, networkOptions, attemptRequest, requestModel, responseModel);
              }
              ...
              return _this.retryOrReject(err, attempt, deferred, networkOptions, attemptRequest, requestModel, responseModel);
            }
          });
        });
        // Handle request timeout.
        req.on('timeout', function () {
          return _this.retryOrReject(new Error('timeout'), attempt, deferred, networkOptions, attemptRequest, requestModel, responseModel);
        });
        req.on('error', function (err) {
          return _this.retryOrReject(err, attempt, deferred, networkOptions, attemptRequest, requestModel, responseModel);
        });
      } catch (err) {
        _this.retryOrReject(err, attempt, deferred, networkOptions, attemptRequest, requestModel, responseModel);
      }
      return deferred.promise;
    };
  ...
  NetworkClient.prototype.POST = function (request) {
    ...
    var attemptRequest = function (attempt) {
      ...
      try {
          ...
          res.on('end', function () {
            try {
              if (res.statusCode === 200) {
                ...
                return _this.retryOrReject(error, attempt, deferred, networkOptions, attemptRequest, request, responseModel);
              }
            } catch (err) {
              return _this.retryOrReject(err, attempt, deferred, networkOptions, attemptRequest, request, responseModel);
            }
          });
        });
        // Handle request timeout.
        ...
        _this.retryOrReject(err, attempt, deferred, networkOptions, attemptRequest, request, responseModel);
      }
      return deferred.promise;
    };
    return attemptRequest(0);
   ...
   */
  NetworkClient.prototype.retryOrReject = function (error, attempt, deferred, networkOptions, attemptRequest, request, responseModel) {
...
var NetworkManager = /** @class */function () {
  ...
  NetworkManager.prototype.validateHttpsAgentConfig = function (httpsAgentConfig) {
    ...
    if (!(0, DataTypeUtil_1.isNumber)(validatedConfig.maxSockets) || !Number.isInteger(validatedConfig.maxSockets) || validatedConfig.maxSockets < constants_1.Constants.MIN_SOCKETS) {
      validatedConfig.maxSockets = defaults.maxSockets;
    }
    // Validate the maxFreeSockets configuration
    if (!(0, DataTypeUtil_1.isNumber)(validatedConfig.maxFreeSockets) || !Number.isInteger(validatedConfig.maxFreeSockets) || validatedConfig.maxFreeSockets < constants_1.Constants.MIN_FREE_SOCKETS) {
      validatedConfig.maxFreeSockets = defaults.maxFreeSockets;
    }
    // Validate the timeout configuration
    if (!(0, DataTypeUtil_1.isNumber)(validatedConfig.timeout) || !Number.isInteger(validatedConfig.timeout) || validatedConfig.timeout < constants_1.Constants.MIN_TIMEOUT) {
...
var ContextWingifyModel_1 = __webpack_require__(/*! ../../../models/user/ContextWingifyModel */ "./dist/server-unpacked/models/user/ContextWingifyModel.js");
var DataTypeUtil_1 = __webpack_require__(/*! ../../../utils/DataTypeUtil */ "./dist/server-unpacked/utils/DataTypeUtil.js");
var ApiEnum_1 = __webpack_require__(/*! ../../../enums/ApiEnum */ "./dist/server-unpacked/enums/ApiEnum.js");
var FunctionUtil_1 = __webpack_require__(/*! ../../../utils/FunctionUtil */ "./dist/server-unpacked/utils/FunctionUtil.js");
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            isGatewayServiceRequiredForHoldouts = holdouts.filter(function (holdout) {
              return holdout.getIsGatewayServiceRequired() === true;
            }).length > 0;
                ...
                switch (_f.label) {
                  ...
                  case 2:
                    this_1.serviceContainer.getLogManager().errorLog('FEATURE_NOT_FOUND_WITH_ID', {
                      ...
                      an: ApiEnum_1.ApiEnum.GET_FLAG,
                      uuid: this_1.context.getUuid(),
                      sId: this_1.context.getSessionId()
                    });
                    return [2 /*return*/, {
                      value: null
                    }];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            tempQueue_1 = manual ? this.queue.splice(0, this.queue.length) // drain everything if manual flush
          ...
          case 1:
            // drain only events per request if automatic flush
            return [2 /*return*/, _a.sent()];
          case 2:
...
/***/ "./dist/server-unpacked/utils/DebuggerServiceUtil.js":
/*!***********************************************************!*\
  !*** ./dist/server-unpacked/utils/DebuggerServiceUtil.js ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4 /*yield*/, Promise.all(variations.map(function (variation) {
            return __awaiter(void 0, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    ...
                    return [4 /*yield*/, serviceContainer.getSegmentationManager().validateSegmentation(variation.getSegments(), context.getVariationTargetingVariables())];
                  case 1:
        ...
        case 1:
          ...
          targetedVariations = matched.map(function (v) {
            return _cloneVariationModelForWhitelisting(v);
          });
...
function doesEventBelongToAnyHoldout(eventName, settings) {
  ...
  return settings.getHoldouts().some(function (holdout) {
    return holdout.getMetrics().some(function (metric) {
      return metric.getIdentifier() === eventName;
    });
  });
}
...
/***/ "./dist/server-unpacked/utils/HoldoutUtil.js":
/*!***************************************************!*\
  !*** ./dist/server-unpacked/utils/HoldoutUtil.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var index_1 = __webpack_require__(/*! ../constants/index */ "./dist/server-unpacked/constants/index.js");
var StorageDecorator_1 = __webpack_require__(/*! ../decorators/StorageDecorator */ "./dist/server-unpacked/decorators/StorageDecorator.js");
/**
...
function getApplicableHoldouts(settings, featureId) {
  ...
  return holdouts.filter(function (holdout) {
    return holdout.getIsGlobal() || holdout.getFeatureIds().includes(featureId);
  });
}
/**
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          if (!applicableHoldouts.length) return [2 /*return*/, {
            matchedHoldouts: [],
            notMatchedHoldouts: [],
            holdoutPayloads: []
          }];
        ...
        case 4:
          ...
          payload = (0, NetworkUtil_1.createHoldoutPayload)(serviceContainer, EventEnum_1.EventEnum.VARIATION_SHOWN, holdout.getId(),
          // campaignId is the holdoutId
          variationId,
          // 1 if IN holdout, 2 if NOT IN holdout
          context, featureId);
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        ...
        case 8:
          ...
          _c.label = 9;
        case 9:
          return [2 /*return*/, updatedNotInHoldoutIds];
      }
    });
  });
}
...
var constants_1 = __webpack_require__(/*! ../constants */ "./dist/server-unpacked/constants/index.js");
var BatchEventsDispatcher_1 = __webpack_require__(/*! ./BatchEventsDispatcher */ "./dist/server-unpacked/utils/BatchEventsDispatcher.js");
var SDKMetaUtil_1 = __webpack_require__(/*! ./SDKMetaUtil */ "./dist/server-unpacked/utils/SDKMetaUtil.js");
/**
 ...
 */
var sendImpressionForVariationShown = function (serviceContainer, campaignId, variationId, context, featureKey, payload) {
  return __awaiter(void 0, void 0, void 0, function () {
    var properties, campaignKeyWithFeatureName, variationName, campaignKey, campaignType;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          properties = (0, NetworkUtil_1.getEventsBaseProperties)(serviceContainer.getSettingsService(), EventEnum_1.EventEnum.VARIATION_SHOWN, encodeURIComponent(context.getUserAgent()),
 ...
 */
var sendImpressionForVariationShownInBatch = function (serviceContainer, payloads) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      if (serviceContainer.getBatchEventsQueue()) {
        ...
        BatchEventsDispatcher_1.BatchEventsDispatcher.dispatch(serviceContainer, {
          ev: payloads
        }, function () {}, {
...
function buildMessage(template, data) {
  ...
  var payload = __assign({
    brand: constants_1.Constants.BRAND_DISPLAY_NAME,
    logPrefix: constants_1.Constants.LOG_PREFIX
  }, data);
  try {
...
var HoldoutUtil_1 = __webpack_require__(/*! ./HoldoutUtil */ "./dist/server-unpacked/utils/HoldoutUtil.js");
var FunctionUtil_1 = __webpack_require__(/*! ./FunctionUtil */ "./dist/server-unpacked/utils/FunctionUtil.js");
var LogMessageUtil_1 = __webpack_require__(/*! ./LogMessageUtil */ "./dist/server-unpacked/utils/LogMessageUtil.js");
/**
            ...
            return __generator(this, function (_e) {
              switch (_e.label) {
                ...
                case 2:
                  ...
                  featureToSkip.push(featureKey);
                  qualifiedHoldoutIds = matchedHoldouts.map(function (holdout) {
                    return holdout.getId();
                  }).join(',');
                  new StorageDecorator_1.StorageDecorator().setDataInStorage({
                    featureKey: featureKey,
            ...
            return __generator(this, function (_d) {
              switch (_d.label) {
                ...
                case 2:
                  ...
                  if (_d.sent() && new CampaignDecisionService_1.CampaignDecisionService().isUserPartOfCampaign(context, campaign, serviceContainer)) {
...
function getTrackEventPath(event, accountId, userId) {
  var path = {
    ...
    sdk: SDKMetaUtil_1.SDKMetaUtil.getInstance().getSdkName(),
    // SDK name constant
    'sdk-v': SDKMetaUtil_1.SDKMetaUtil.getInstance().getVersion(),
    // SDK version
...
function getEventsBaseProperties(settingsService, eventName, visitorUserAgent, ipAddress, isUsageStatsEvent, usageStatsAccountId) {
  ...
  if (isUsageStatsEvent === void 0) {
    isUsageStatsEvent = false;
  }
  if (usageStatsAccountId === void 0) {
...
function sendPostApiRequest(serviceContainer_1, properties_1, payload_1, userId_1) {
  return __awaiter(this, arguments, void 0, function (serviceContainer, properties, payload, userId, eventProperties, campaignInfo) {
    var retryConfig, isGatewayServiceConfigured, headers, userAgent, ipAddress, request, apiName, extraDataForMessage;
    var _a;
    if (eventProperties === void 0) {
      eventProperties = {};
    }
    if (campaignInfo === void 0) {
      campaignInfo = {};
    }
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          if (properties.en === EventEnum_1.EventEnum.VARIATION_SHOWN) {
            apiName = ApiEnum_1.ApiEnum.GET_FLAG;
            if (campaignInfo.campaignType === CampaignTypeEnum_1.CampaignTypeEnum.ROLLOUT || campaignInfo.campaignType === CampaignTypeEnum_1.CampaignTypeEnum.PERSONALIZE) {
            ...
            } else if (properties.en !== EventEnum_1.EventEnum.DEBUGGER_EVENT && properties.en !== EventEnum_1.EventEnum.LOG_EVENT && properties.en !== EventEnum_1.EventEnum.INIT_CALLED) {
              apiName = ApiEnum_1.ApiEnum.TRACK_EVENT;
...
function getDebuggerEventPayload(settingsService, eventProps) {
  ...
  properties.d.event.props.vwoMeta = __assign(__assign({}, eventProps), {
    ...
    sn: SDKMetaUtil_1.SDKMetaUtil.getInstance().getSdkName(),
    sv: SDKMetaUtil_1.SDKMetaUtil.getInstance().getVersion(),
    'src-v': constants_1.Constants.SDK_NAME + '-' + constants_1.Constants.SDK_VERSION,
...
function sendEvent(serviceContainer, properties, payload, eventName) {
  return __awaiter(this, void 0, void 0, function () {
    var deferredObject, isGatewayServiceConfigured, retryConfig, request;
    var _a;
    return __generator(this, function (_b) {
      deferredObject = new PromiseUtil_1.Deferred();
      isGatewayServiceConfigured = Boolean((_a = serviceContainer.getWingifyOptions()) === null || _a === void 0 ? void 0 : _a.gatewayService);
      ...
      if (eventName === EventEnum_1.EventEnum.DEBUGGER_EVENT) retryConfig.shouldRetry = false;
      try {
...
/***/ "./dist/server-unpacked/utils/SDKMetaUtil.js":
/*!***************************************************!*\
  !*** ./dist/server-unpacked/utils/SDKMetaUtil.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./dist/server-unpacked/utils/SdkInitAndUsageStatsUtil.js":
/*!****************************************************************!*\
  !*** ./dist/server-unpacked/utils/SdkInitAndUsageStatsUtil.js ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var UsageStatsUtil = /** @class */function () {
  ...
  UsageStatsUtil.prototype.setUsageStats = function (options) {
    ...
    var storage = options.storage,
      ...
      batchEventData = options.batchEventData,
      gatewayService = options.gatewayService,
      integrations = options.integrations,
      pollInterval = options.pollInterval,
      _wingify_meta = options._wingify_meta,
...
/***/ "wingify-fme-sdk-log-messages":
/*!***********************************************!*\
  !*** external "wingify-fme-sdk-log-messages" ***!
  \***********************************************/
/***/ ((module) => {

"use strict";
module.exports = require("wingify-fme-sdk-log-messages");
...
/*!***********************************************!*\
  !*** ./dist/server-unpacked/index.wingify.js ***!
  \***********************************************/
...
var NetworkTransportModeEnum_1 = __webpack_require__(/*! ./enums/NetworkTransportModeEnum */ "./dist/server-unpacked/enums/NetworkTransportModeEnum.js");
Object.defineProperty(exports, "NetworkTransportModeEnum", ({
  enumerable: true,
  get: function () {
    return NetworkTransportModeEnum_1.NetworkTransportModeEnum;
  }
}));
var Wingify_1 = __webpack_require__(/*! ./Wingify */ "./dist/server-unpacked/Wingify.js");
Object.defineProperty(exports, "init", ({
  enumerable: true,
  get: function () {
    return Wingify_1.init;
  }
}));
Object.defineProperty(exports, "onInit", ({
  enumerable: true,
  get: function () {
    return Wingify_1.onInit;
  }
}));
})();
...
/******/ })()
;
//# sourceMappingURL=wingify-fme-node-sdk.js.map