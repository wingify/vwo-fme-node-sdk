...
export interface IVWOClient {
    ...
    trackEvent(eventName: string, context: Record<string, any>, eventProperties?: Record<string, dynamic>): Promise<Record<string, boolean>>;
...
export declare class VWOClient implements IVWOClient {
     ...
     */
    setAttribute(attributeOrAttributes: string | Record<string, boolean | string | number>, attributeValueOrContext?: boolean | string | number | Record<string, any>, context?: Record<string, any>): Promise<void>;
    /**
