 ...
 */
export declare class DecisionMaker {
  /**
   ...
   */
  generateBucketValue(hashValue: number, maxValue: number, multiplier?: number): number;
  /**
   ...
   */
  getBucketValueForUser(hashKey: string, maxValue?: number): number;
  /**
   ...
   * @returns {number} - The calculated bucket value
   */
  calculateBucketValue(str: string, multiplier?: number, maxValue?: number): number;
  /**
