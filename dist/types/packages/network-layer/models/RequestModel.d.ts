...
export declare class RequestModel {
     ...
     */
    constructor(url: string, method: string, path: string, query: Record<string, dynamic>, body: Record<string, dynamic>, headers: Record<string, string>, scheme: string, port: number, retryConfig?: IRetryConfig);
    /**
