...
interface ITrack {
    track(settings: any, eventName: string, eventProperties: any, context: any, hookManager: HooksManager): Promise<Record<string, boolean>>;
}

export class TrackApi implements ITrack {
    async track(settings: any, eventName: string, eventProperties: any, context: any, hookManager: HooksManager): Promise<Record<string, boolean>> {
